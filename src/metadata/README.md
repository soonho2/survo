 ...
 * [survo.yml](survo.yml)
     * Determines how your purl.obolibrary.org/obo/survo/ redirects will be handled
     ...
     * Paste in the contents of [survo.yml](survo.yml)
 ...
 * [survo.md](survo.md)
     ...
     * Paste in the contents of [survo.md](survo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
